...
<body>
	...
	<aside class="categories well well-sm">
			...
			<th>Books by Courses:</th>
				<tr><td><a href="Library01.php?ID=Accountancy">Accountancy</a></td></tr>
				<tr><td><a href="Library01.php?ID=Applied Mathematics">Applied Mathematics</a></td></tr>
				<tr><td><a href="Library01.php?ID=Biology">Biology</a></td></tr>
				<tr><td><a href="Library01.php?ID=Business Administration">Business Administration</a></td></tr>
				<tr><td><a href="Library01.php?ID=Chemical Engineering">Chemical Engineering</a></td></tr>
				<tr><td><a href="Library01.php?ID=Chemistry">Chemistry</a></td></tr>
				<tr><td><a href="Library01.php?ID=Communication and Media Studies">Communication and Media Studies</a></td></tr>
				<tr><td><a href="Library01.php?ID=Community Development">Community Development</a></td></tr>
				<tr><td><a href="Library01.php?ID=Computer Science">Computer Science</a></td></tr>
				<tr><td><a href="Library01.php?ID=Economics">Economics</a></td></tr>
				<tr><td><a href="Library01.php?ID=Fisheries">Fisheries</a></td></tr>
				<tr><td><a href="Library01.php?ID=Food Technology">Food Technology</a></td></tr>
				<tr><td><a href="Library01.php?ID=History">History</a></td></tr>
				<tr><td><a href="Library01.php?ID=Literature">Literature</a></td></tr>
				<tr><td><a href="Library01.php?ID=Management">Management</a></td></tr>
				<tr><td><a href="Library01.php?ID=Political Science">Political Science</a></td></tr>
				<tr><td><a href="Library01.php?ID=Psychology">Psychology</a></td></tr>
				<tr><td><a href="Library01.php?ID=Public Health">Public Health</a></td></tr>
				<tr><td><a href="Library01.php?ID=Sociology">Sociology</a></td></tr>
				<tr><td><a href="Library01.php?ID=Statistics">Statistics</a></td></tr>				
			</table>
	</aside>
  ...
  <content id="lib_prev_next">
  	<?php if($page=='0' and $totalpages!='0'){ ?>
		<a href="Library01.php?page=<?php echo $page+1?>&amp;ID=<?php echo $course?>" id="next" >Next >> </a>
	<?php }else if($page==$totalpages-1 and $totalpages!='0'){ ?>
	 	<a href="Library01.php?page=<?php echo $page-1?>&amp;ID=<?php echo $course?>" id="prev" ><< Prev </a>
	<?php }else if($totalpages=='0'){ ?>
		<p></p>
	<?php }else{ ?>
	 	<a href="Library01.php?page=<?php echo $page-1?>" name="page"><< Prev</a>  &nbsp;|&nbsp;
	    <a href="Library01.php?page=<?php echo $page+1?>" id="next" name="page">Next >></a>
	 <?php } ?>
	</content>
</div>
</div>
